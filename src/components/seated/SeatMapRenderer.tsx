...
export function SeatMapRenderer({ snapshot, seats, resolveVisualStatus, onToggleSeat }: Props) {
  ...
  return (
    <div className="w-full overflow-auto rounded-xl border border-border bg-card/40">
      <svg
        viewBox={`0 0 ${width} ${height}`}
        className="block w-full h-auto"
        style={{ background: bg, maxHeight: '70vh' }}
      >
        {/* Objetos decorativos */}
