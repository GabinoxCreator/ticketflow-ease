  ...
  useEffect(() => {
    if (user && !isLoading) {
      if (isProdutor) {
        ...
        navigate('/area-do-produtor/cadastro');
      }
    }
          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden p-6">
            {forgotMode ? (
              <div className="space-y-4">
                ...
                {resetSent ? (
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-4">
                    <p className="text-sm text-muted-foreground">Informe seu email para receber um link de recuperação.</p>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <h2 className="font-display font-semibold text-lg mb-2">Entrar como Produtor</h2>
                ...
                <div className="flex justify-end">
                  <button type="button" onClick={() => { setForgotMode(true); setResetEmail(email); }} className="text-sm text-primary hover:underline">
                    Esqueceu sua senha?
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  <Button type="button" variant="outline" className="w-full gap-2" size="lg" onClick={async () => {
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Não tem conta?{' '}
                  <Link to="/area-do-produtor/cadastro" className="text-primary hover:underline font-medium">
