...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Creating onboarding link for account", { accountId });
    const accountLink = await stripe.accountLinks.create({
      account: accountId,
      refresh_url: `${origin}/dashboard/financeiro?refresh=true`,
      return_url: `${origin}/dashboard/financeiro?success=true`,
