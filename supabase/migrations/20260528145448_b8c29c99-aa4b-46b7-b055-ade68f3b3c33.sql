...
BEGIN
  ...
  LOOP
    ...
    -- Rejeita addons acima do teto. Sem clamp: qtd e preço de fonte única.
...
REVOKE ALL ON FUNCTION public.create_seat_order(uuid, uuid, text, jsonb, numeric, numeric, text, text, text, text, text, interval) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.create_seat_order(uuid, uuid, text, jsonb, numeric, numeric, text, text, text, text, text, interval) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.create_seat_order(uuid, uuid, text, jsonb, numeric, numeric, text, text, text, text, text, interval) TO service_role;